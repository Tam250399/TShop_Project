                    ...
                    <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/90 to-gray-100 text-white rounded-3xl relative h-[320px] flex items-end'>
                        <div>
                            <div className='mb-4'>
                                ...
                                <p className='text-4xl xl:text-5xl font-bold opacity-50 mb-2'>Máy chơi game</p>
                                <Button
                                    text="Mua ngay"
                                    bgColor={"bg-primary"}
                    ...
                    <div className='py-10 pl-5 bg-gradient-to-br from-brandGreen/90 to-brandGreen/90 text-white rounded-3xl relative h-[320px] flex items-end'>
                        <div>
                            <div className='mb-4'>
                                <p className='mb-[2px] text-white'>Tận hưởng</p>
                                <p className='text-2xl font-semibold mb-[2px]'>Với</p>
                                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>Kính </p>
                                <Button
                                    text="Mua ngay"
                                    bgColor={"bg-white"}
                    ...
                    <div className='py-10 pl-5 bg-gradient-to-br from-brandBlue to-brandBlue/70 text-white rounded-3xl relative h-[320px] flex items-start'>
                        <div>
                            <div className='mb-4'>
                                <p className='mb-[2px] text-white'>Tận hưởng</p>
                                <p className='text-2xl font-semibold mb-[2px]'>Với</p>
                                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>Loa</p>
                                <Button
                                    text="Mua ngay "
                                    bgColor={"bg-white"}
