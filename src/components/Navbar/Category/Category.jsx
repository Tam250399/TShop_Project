            ...
            <div className='container'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                    ...
                    <div className='py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px] flex items-end'>
                        <div>
                            <div className='mb-4'>
                                <p className='mb-[2px] text-white'>Tận hưởng</p>
                                <p className='text-2xl font-semibold mb-[2px]'>Với</p>
                                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>Tai nghe</p>
                                <Button
                                    text="Mua ngay "
                                    bgColor={"bg-primary"}
                    ...
                    <div className='py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end'>
                        <div>
                            <div className='mb-4'>
                                <p className='mb-[2px] text-gray-400'>Tận hưởng</p>
                                <p className='text-2xl font-semibold mb-[2px]'>Với</p>
                                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>Đồng hồ</p>
                                <Button
                                    text="Mua ngay"
                                    bgColor={"bg-white"}
                    ...
                    <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-[320px] flex items-end'>
                        <div>
                            <div className='mb-4'>
                                <p className='mb-[2px] text-white'>Tận hưởng</p>
                                <p className='text-2xl font-semibold mb-[2px]'>Với</p>
                                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>Máy tính</p>
                                <Button
                                    text="Mua ngay"
                                    bgColor={"bg-white"}
